    ...
    <div class="col-5">
        <div class="container">
            ...
            <div class="form-group">
                ...
                <input type="text" name="titre2" id="" class="form-control" value="">
            </div>
            <div class="form-group">
                <label for="ExampleInputEmail" class="mt-5">Description Secondaire</label>
                <input type="text" name="description2" id="" class="form-control" value="">
            </div>
            <div class="form-group">
                <label for="" class="mt-5">Image URL</label>
                <input type="text" name="img_about" id="" class="form-control" value="">
            </div>
